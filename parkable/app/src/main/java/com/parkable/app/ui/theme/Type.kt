...
/** Tipografía Parkable. Usa la fuente del sistema con pesos balanceados. */
val ParkableTypography = Typography(
    displayLarge = TextStyle(fontWeight = FontWeight.ExtraBold, fontSize = 32.sp, lineHeight = 40.sp),
